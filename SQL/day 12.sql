...
select emp.emp_id,emp.emp_name,emp.manager_id, mngr.emp_id, mngr.emp_name, mngr.salary from employee as emp join employee as mngr 
where emp.manager_id=mngr.emp_id;

-- how many no of employee of each manager
