...
-- inner join==> inner likhoge to where ki jgh on likho
...
-- natural join=> perform on same column, jab same column nhi h to y cross join ya cartesian join  ki trh react kega 
